        ...
        <>
            <MyContainer>
                ...
                <p className="md:text-3xl text-2xl font-medium font-latoFont text-center md:leading-tight leading-tight">
                    ...
                    When the wisdom is rekindled people can discriminate between good and bad.  One can obtain ever lasting Joy by reviving LOVE.
                </p>

                <p className="md:text-lg text-base font-medium py-5 font-latoFont">
                    Situated near the West coast of India,  Pune, known by many as 'the Oxford  of the East' has been celebrated since  medieval times as a high seat of learning. Multitudes of academic institutions dot this city of over four million  even today. The focus of learning has  always been education to combine  competence with character, culture to  bring out the best in an individual and  devotion to one&apos;s duty and the  Supreme divinity that unites all living  beings.
                </p>
                ...
                <p className="md:text-lg text-base font-medium pb-5 font-latoFont">
                    When the wisdom is rekindled people can discriminate between good and bad, by that surely they will be able to say NO to bad habits & yes to life and when the real love is revived people won’t search for happiness outside through alcohol, drug’s, illicit relationships and so on. So VOICE makes DRUG DE-ADDICTION a easy and a happy process because as soon a person gets a higher taste he will no longer look down to petty stupid lower tastes like drinking, smoking, drug’s.
                </p>

                <AboutTitle title={"VOICE History"} />

                <p className="md:text-lg text-base font-medium pb-5 font-latoFont">
                    In 1996, a team of youths from engineering colleges of  Pune under guidance of  Radheshyam Das started the activities of VOICE by coming together  and venturing into the wisdom literatures and lives of great  personalities, with the desire to bring about a positive  revolution in the misguided lives of modern youth. Today  VOICE has taken a great shape in several universities in  India and abroad.
                    <br />
                    <br />
                    The education and culture oﬀered by VOICE is non-sectarian and meant for people of any religion, caste, creed, color  or nationality. It is for bringing about the welfare of all  humanity. It is easy to understand and practical to apply  wisdom. It teaches proven knowledge that has touched  and transformed the lives of thousands of youths.
                </p>

                <AboutTitle title={"Goals of VOICE"} />

                <p className="md:text-lg text-base font-medium pb-5 font-latoFont">
                    1. Training and education in Science and Spirituality as well as Leadership and Self-excellence skills by application of timeless wisdom in modern scenario.
                    2. Creating Role model perfect gentlemanly youths with noble qualities, Character, Competence and Spiritual wisdom.
                    <br />
                    <br />
                    3. Saving youth from self-destructive habits that harm body and mind through positive progressive engagements.
                    <br />
                    <br />
                    4. Use Arts, Culture, Music and Media to distribute the message of Vedic Wisdom.
                    <br />
                    <br />
                    5. Engage youth talents for creating a happy, holistic and harmonious divine society.
                    <br />
                    <br />
                    6. Reach subsidized spiritual literature for youths to rekindle wisdom and revive love.
                    <br /><br />
                    7. Establishing youth communities for caring and counseling youth in holistic life.
                    <br />
                    <br />
                    8. Balancing Personal and Professional Life by self-managing long-enduring leadership.
                </p>
            </MyContainer>
        </>
    );
